...
declare -a CTRL1=(10.0.13.2 6633)
...
declare -a vi1=(10.0.13.1/24 1 5)
declare -a vi2=(10.0.0.1/24 1 5)
declare -a vi3=(10.0.2.2/24 1 5)
declare -a vi4=(10.0.5.1/24 1 5)
declare -a OSPFNET=(NET1 NET2 NET3 NET4 NET5)
declare -a NET1=(172.16.0.3/32 0.0.0.0)
declare -a NET2=(10.0.13.0/24 0.0.0.0)
...
declare -a VI=(vitap1 vitap2)
declare -a vitap1=(10.0.13.2/24)
declare -a vitap2=(10.0.6.1/24)
declare -a STATICROUTE=(10.0.0.0 255.0.0.0 10.0.13.1 vitap1)
declare -a ENDIP1=(192.168.1.3 eth1)
declare -a ENDIP2=(192.168.1.2 eth1)
# 62.40.110.51 - end
