...
declare -a TAP=(tap1)
declare -a tap1=(1191 1192 10.0.5.2/24 ENDIP1)
declare -a STATICROUTE=(10.0.0.0 255.0.0.0 10.0.5.1 tap1)
...
declare -a TAP=(tap1)
declare -a tap1=(1191 1192 10.0.4.1/24 ENDIP1)
